...
export const courses: Course[] = [
  {
    id: "1",
    title: "מניקור ולק ג'ל",
    description:
      "קורס אחד שמכסה את שני החלקים: הבסיס המקצועי של המניקור, ומריחת לק ג'ל נקייה ועמידה.",
    ...
    detail: {
      ...
      longDescription:
        "הקורס הפרטי הזה הוא הבסיס שכל מניקוריסטית חייבת לעבור לפני כל טכניקה מתקדמת, והוא כולל גם את העבודה עם לק ג'ל. נלמד יחד להבין על מה בדיוק אנחנו עובדות, איך עובדים נכון ובטוח, ואיך מגיעות לתוצאה נקייה ואחידה שנשארת יפה לאורך זמן. אני מלמדת אחת על אחת, בקצב שלך, עם תרגול מעשי בכל מפגש, ומלווה אותך גם בין המפגשים. בסוף הקורס את מקבלת חוברת עבודה מלאה שתישאר איתך גם אחרי שנסיים.",
      modules: [
        ...
        "לק ג'ל: הכנת הציפורן, פריימר ובסיס",
        "לק ג'ל: מריחה בשכבות, ייבוש במנורה וטופ",
        "לק ג'ל: הסרה נכונה בלי לפגוע בציפורן",
